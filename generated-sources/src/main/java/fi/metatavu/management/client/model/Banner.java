...
public class Banner   {
  ...
  **/
  ...
  public Banner template(String template) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(date, dateGmt, guid, id, link, modified, modifiedGmt, slug, status, type, password, title, content, featuredMedia, template, bannerLink);
  }
