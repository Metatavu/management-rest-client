...
/**
 * Kohteen ainutkertainen tunnusnumero.
 */
@ApiModel(description = "Kohteen ainutkertainen tunnusnumero.")
...
public class PostGuid   {
  ...
  public PostGuid raw(String raw) {
   ...
   /**
   * Kohteen GUID sellaisena kuin se on tietokannassa.
   * @return raw
  **/
  @ApiModelProperty(example = "null", value = "Kohteen GUID sellaisena kuin se on tietokannassa.")
  ...
  public PostGuid rendered(String rendered) {
   ...
   /**
   * Kohteen GUID, sellaisena kuin se tulostetaan selaimelle.
   * @return rendered
  **/
  @ApiModelProperty(example = "null", value = "Kohteen GUID, sellaisena kuin se tulostetaan selaimelle.")
